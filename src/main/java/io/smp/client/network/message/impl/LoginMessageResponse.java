...
public class LoginMessageResponse extends InputMessage {

    public LoginMessageResponse(byte[] contents) {
    ...
    public Message deSerialize(byte[] contents) {
        if (contents[0] == 1) {
            ...
            exception = new SmpException(new String(Arrays.copyOfRange(contents, 1, contents.length)));
        }
        return this;
    }
}
