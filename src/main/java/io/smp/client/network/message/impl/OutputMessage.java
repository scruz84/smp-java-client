...
public abstract class OutputMessage implements Message {

    @Override
    public Message deSerialize(byte[] contents) {
        throw new UnsupportedOperationException("OutputMessage does not implement deSerialize(byte[]) method");
    }
}
