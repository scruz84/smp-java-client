...
public interface Channel {
    ...
    void write(ByteBuffer... byteBuffers) throws ChannelWriteException;

    void dispatchWrite(Message message) throws ChannelWriteException;

    boolean dispatchRead() throws ChannelReadException;
}
